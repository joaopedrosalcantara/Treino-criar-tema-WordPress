		...
		<section class="top-bar">
			<div class="container">
				<div class="row d-flex align-items-center ">
					...
					<div class="search col-xl-3 col-sm-5 col-6"><?php get_search_form(); ?></div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="row">
					<section class="logo col-md-2 col-12 text-center">
			 		...
			 		<nav class="main-menu col-md-10 text-right"><?php wp_nav_menu(array('theme_location' => 'my_main_menu')); ?></nav>
				</div>
			</div>
		</section>
	</header>